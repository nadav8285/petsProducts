    ...
    return (<>
        <div style={{ direction: 'rtl', marginRight: '25px' }}>
            <div style={{ width: '60%', fontSize: '18px', fontFamily: "Alef Hebrew" }}>
                <h1>מיטות מעץ מלא מסוג אורן לכלבים וחתולים</h1>
                ...
                <i>לפניכם מגוון רחב של מיטות מעץ לכלבים וחתולים. בחרו את המיטה והגודל המתאימים ביותר עבור חיית המחמד שלכם! אם אתם לא בטוחים לגבי המידות המתאימות, אל תהססו לפנות אלינו ונשמח לעזור לכם לבחור את המיטה המתאימה ביותר.</i>
            </div>
        </div>
